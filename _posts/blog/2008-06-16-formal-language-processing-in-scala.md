...
categories:
- Scala
date: '2008-06-16 00:00:51 '
layout: post
title: Formal Language Processing in Scala
wordpress_id: 238
wordpress_path: /scala/formal-language-processing-in-scala
---
...
Pat yourself on the back!  This is all that is required to wire up a very simple language interpreter.  The full source is linked at the [bottom of the article](<#bottom>).
